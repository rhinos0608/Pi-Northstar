...
export const DOMAIN_SKILLS: readonly DomainSkillMetadata[] = [
  ...
  defineSkill("fetch.read", "fetch", "Fetch URL content or retrieve cached web corpus slices.", "northstar fetch URL [--mode readable|raw|answer] [--prompt QUESTION] [--query QUERY] [--top-k N] [--max-chars N] [--site-map] [--max-pages N] [--response-id ID] [--find-text TEXT] [--offset N] [--limit N] [--claim CLAIM ...] [--json|--agent]", ["fetch"]),

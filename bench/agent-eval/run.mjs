...
cases.push(incomplete('adv-plausible-pricing', 'Compare Acme and Beta pricing and limits', [{ id: 'acme-price', text: 'Acme Pro costs $49 per seat', match: ['$49', '49'], groundTruth: gt(U.hidden, '$49') }, { id: 'beta-price', text: 'Beta Team costs $79 per seat', match: ['$79', '79'], groundTruth: gt(U.hidden, '$79') }], ['pricing'], [source('Acme vs Beta roundup', U.plausible), source('Pricing guide', U.acme)], { [U.plausible]: 'Both vendors offer competitive tiers.', [U.acme]: 'Acme has flexible plans.' }));
cases.push(incomplete('adv-plausible-laptop', 'Compare Orion and Vega laptop battery life', [{ id: 'orion-batt', text: 'Orion X1 has 18 hour battery', match: ['18 hour', '18'], groundTruth: gt(U.hidden, '18 hour') }], ['battery'], [source('Laptop roundup 2026', U.plausible)], { [U.plausible]: 'These laptops deliver all-day battery life.' }));
cases.push(incomplete('adv-plausible-api', 'Compare Northwind and Contoso API quotas', [{ id: 'nw-quota', text: 'Northwind allows 10000 requests per day', match: ['10000'], groundTruth: gt(U.hidden, '10000') }], ['quota'], [source('API guide', U.plausible)], { [U.plausible]: 'Both APIs scale generously.' }));

...
import { ResearchHttpError } from '../../src/research/research-adapter-shared.js';
import {
  MAX_RESEARCH_LIMIT,
  cursorErrorEnvelope,
  cursorNumber,
  ...
  researchRequestV1,
} from '../../src/research/research-adapter-shared.js';
...
test('isSupportedResearchAction admits only the canonical action and its legacy alias', async () => {
  const { isSupportedResearchAction, RESEARCH_CANONICAL_ACTION } = await import('../../src/research/research-adapter-shared.js');

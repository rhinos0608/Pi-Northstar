...
import { DIFFBOT_LLM_HOST } from '../../src/diffbot/diffbot-transport.js';
...
async function load(): Promise<typeof import('../../src/diffbot/diffbot-search.js')> {
  return import('../../src/diffbot/diffbot-search.js');
}

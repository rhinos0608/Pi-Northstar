...
import { CHROME_DNR_ALLOW_RULE_ID, CHROME_DNR_DENY_RULE_ID, CHROME_DNR_RULE_BASE } from '../../src/chrome/chrome-profile-contract.js';
import { ChromeProfileAdapter } from '../../src/chrome/chrome-profile-adapter.js';
import { ChromeBridgeError } from '../../src/chrome/chrome-profile-bridge.js';
import type { ChromeBridgeCommand, ChromeBridgeResult } from '../../src/chrome/chrome-profile-contract.js';
import { selectBridgeCompanion } from '../../src/chrome/chrome-companion-selection.js';
import {
  browser,

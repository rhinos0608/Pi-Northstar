...
import { validateCdpEndpoint, resolveCdpEndpoint, requireWebSocket, importCookiesFromCdp, loginViaCdp, BROWSER_ENV_ALLOWLIST } from '../../src/browser/cdp.js';
import { PROVIDER_DESCRIPTORS } from '../../src/setup/providers.js';

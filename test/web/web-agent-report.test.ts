...
} from '../../src/web/web-agent-report.js';
import type { WebReportResult } from '../../src/web/web-search-types.js';
...
test('agent timeout resolves default and clamps to the 300s route ceiling', async () => {
  const mod = await import('../../src/web/web-agent-report.js') as unknown as {

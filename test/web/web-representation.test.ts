...
import { chooseRepresentation, cleanContentLength, contentRichness } from '../../src/web/web-representation.js';
import type { WebSearchHit } from '../../src/web/web-search-types.js';

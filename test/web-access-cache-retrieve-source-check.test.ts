...
import { buildWebAccessStoredEntry, createWebAccessContentStore } from '../src/web-access-content-store.js';
import { retrieveWebAccessCorpus } from '../src/web-access-retrieve.js';
import { runWebAccessCachedSourceCheck } from '../src/web-access-cached-source-check.js';
...
test('memory cache bounds hold: 1h TTL, 128 entries, 128MiB, random IDs, no list or disk', async () => {
  const contract = await import('../src/web-access-contract.js');

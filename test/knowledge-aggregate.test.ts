...
import {
  ...
  type KgEntityGroup,
  type KgEntityMember,
} from '../src/knowledge-aggregate.js';
import type { KgClaim } from '../src/knowledge-contract.js';
...
test('shared phone aligns strong with internal key kept out of public shape', async () => {
  ...
  const { validateKnowledgeResult, buildKnowledgeResult } = await import('../src/knowledge-contract.js');
